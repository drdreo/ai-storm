...
describe("launchArgsForProfile — MCP launch context (mcp-idea-capture §4.3)", () => {
  ...
  it("wires the claude profile with --mcp-config + --allowedTools exactly once", () => {
    ...
    expect(args[args.indexOf("--allowedTools") + 1]).toBe(
      "mcp__ai-storm__capture_idea,mcp__ai-storm__set_project_title,mcp__ai-storm__capture_score,mcp__ai-storm__mark_idea_done,mcp__ai-storm__link_idea,mcp__ai-storm__get_board_ideas,mcp__ai-storm__get_projects"
    );
