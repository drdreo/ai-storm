...
extracted ideas land as spatial cards — across multiple isolated projects, with
...
WebSocket multiplexer, the Yjs project registry, the per-project ingestion
...
confirms the app boots, tldraw mounts, projects create/rename, a real PowerShell
...
Key events you can trace per project: `ws.open/close`, `attach.request`,
